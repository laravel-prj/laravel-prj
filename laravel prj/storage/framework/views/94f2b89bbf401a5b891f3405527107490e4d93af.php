...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
          <img class="animation__shake" src="<?php echo e(asset('admin/images/logo.png')); ?>" alt="AdminMO" height="120" width="120">
        </div>
...
<?php /**PATH C:\Users\IVS1\Desktop\prj\public\laravel-prj\laravel prj\resources\views/admin/layouts/master.blade.php ENDPATH**/ ?>