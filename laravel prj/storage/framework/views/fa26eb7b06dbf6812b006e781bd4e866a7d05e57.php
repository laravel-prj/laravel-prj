                                ...
                                <tr>
                                    ...
                                    <td class="project-actions text-right">
                                        <a class="btn btn-info btn-sm"
                                            href="<?php echo e(asset("admin-mo/brand/updateBrand/$item->id")); ?>">
                                            <i class="fas fa-pencil-alt">
                                            </i>
                                            Edit
                                        </a>
                                        <a class="btn btn-danger btn-sm"
                                            href="<?php echo e(asset("admin-mo/deleteBrand/$item->id")); ?>">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Code\laravel prj\laravel prj\resources\views/admin/pages/bands/index.blade.php ENDPATH**/ ?>