                ...
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a class="btn btn-primary btn-sm btn-create"
                            href="<?php echo e(asset('admin-mo/brand/create')); ?>">Create</a>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td class="project-actions text-right">
                                        <a class="btn btn-info btn-sm"
                                            href="<?php echo e(asset("admin-mo/brand/update/$item->id")); ?>">
                                            <i class="fas fa-pencil-alt"></i>Edit
                                        </a>
                                        
                                        <a class="btn btn-danger btn-sm" href="javascript:void(0);"
                                            onclick="return onDeleteBrand(<?php echo e($item->id); ?>);">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\IVS1\Desktop\prj\public\laravel-prj\laravel prj\resources\views/admin/pages/brands/index.blade.php ENDPATH**/ ?>