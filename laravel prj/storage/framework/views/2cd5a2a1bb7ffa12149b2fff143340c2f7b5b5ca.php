...
<div class="container-storage">
    ...
    <section>
      <div class="container" style="max-width: 1260px; width: 100%; margin: auto">
        <div class="div1">
          <div class="image">
            <img src="<?php echo e(asset('customer/img/contactus.png')); ?>" class="image1">
          </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('customer.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\linh\OneDrive\Máy tính\laravel prj\resources\views/customer/pages/contact.blade.php ENDPATH**/ ?>