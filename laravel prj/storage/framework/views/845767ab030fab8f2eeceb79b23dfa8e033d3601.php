                         ...
                         <tbody id="tableBody">
                            <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr id = "tr<?php echo e($key); ?>">
                                    ...
                                    <td><input class="aa-cart-quantity" type="number" min="1" max="<?php echo e($item['quantity']); ?>"
                                        name="<?php echo e($key); ?>"
...
<?php echo $__env->make('customer.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\linh\OneDrive\Máy tính\laravel prj\resources\views/customer/pages/cart.blade.php ENDPATH**/ ?>