                ...
                <div class="seq-screen">
                    <ul class="seq-canvas">
                        ...
                        <li>
                            ...
                            <div class="seq-title">
                                <a data-seq href="<?php echo e(asset('/shop')); ?>" class="aa-shop-now-btn aa-secondary-btn">SHOP
                                    NOW</a>
                            </div>
                        </li>
                        <!-- single slide item -->
                        <li>
                            <div class="seq-model">
                                <img data-seq src="<?php echo e(asset('customer/img/slide2.jpg')); ?>" style="height: 500px" />
                            </div>
                            <div class="seq-title">
                        ...
                        <li>
                            <div class="seq-model">
                                <img data-seq src="<?php echo e(asset('customer/img/slide3.jpg')); ?>" style="height: 500px" />
                            </div>
                            <div class="seq-title">
                                <a data-seq href="#" class="aa-shop-now-btn aa-secondary-btn">SHOP NOW</a>
                            </div>
                        ...
                        <div class="aa-popular-category-area">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade in active" id="popular">
                                    ...
                                    <a class="aa-browse-btn" href="<?php echo e(asset('/topProduct')); ?>">Browse all Product
                        ...
                        <div class="aa-popular-category-area">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade in active" id="popular">
                                            ...
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img"
                                                        href="<?php echo e(asset("detail/$saleitem->id")); ?>"><img
                                                            src="<?php echo e(asset("customer/img/$saleitem->image")); ?>"
                                                            width="100%" height="300px" /></a>
                                                    <a class="aa-add-card-btn" data-product-id="<?php echo e($saleitem->id); ?>"
                                                        href="<?php echo e(asset("detail/$saleitem->id")); ?>"><span
                                                            class="fa fa-shopping-cart">
                                                        </span>Details
                                                    </a>
                                                    <figcaption>
                                                        <h4 class="aa-product-title">
                                                            <a
                                                                href="<?php echo e(asset("detail/$saleitem->id")); ?>"><?php echo e($saleitem->name); ?></a>
                                                        </h4>
                                                        <span
                                                            class="aa-product-price"><?php echo e($saleitem['price'] - ($saleitem['price'] * $saleitem['discout_item']) / 100); ?></span><span
                                                            class="aa-product-price"><del><?php echo e($saleitem->price); ?></del></span>
                                                    </figcaption>
                                                </figure>
                                                <!-- product badge -->
                                    ...
                                    <a class="aa-browse-btn" href="<?php echo e(asset('/saleProduct')); ?>">Browse all Product
                                        <span class="fa fa-long-arrow-right"></span></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="aa-client-brand-area">
                        <ul class="aa-client-brand-slider">
                            <?php $__currentLoopData = $navbar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <a href="<?php echo e(asset("band/$brand->id")); ?>"><img
                                            src="<?php echo e(asset("customer/img/brand/$brand->img")); ?>" width="100px" /></a>
                                </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('customer.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp8\htdocs\laravel-prj\laravel prj\resources\views/customer/pages/index.blade.php ENDPATH**/ ?>