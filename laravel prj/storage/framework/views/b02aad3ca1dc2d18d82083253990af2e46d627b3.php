                     ...
                     <div class="aa-prod-quantity">
                       <form>
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                         <input type="radio" class="custom-control-input" <?php if($loop->index == 0): ?> checked <?php endif; ?> name="size" onchange="sizechange(<?php echo e($size->id); ?>)">
...
<script>
  function sizechange(id){
    ...
    const url = "http://"+window.location.host + "/api/ajaxGetSizeById/";
    console.log(url);
      $.ajax({
          type: "GET",
          url: url,
...
<?php echo $__env->make('customer.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Desktop\mới\laravel prj\resources\views/customer/pages/detail.blade.php ENDPATH**/ ?>