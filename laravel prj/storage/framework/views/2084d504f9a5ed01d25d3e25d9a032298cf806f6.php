          ...
          <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
               ...
               with font-awesome or any other icon font library -->
                  ...
                  <li class="nav-item">
                      <a href="<?php echo e(asset('admin-mo/item/index')); ?>" class="nav-link">
...
<?php /**PATH C:\xampp8\htdocs\laravel-prj\laravel prj\resources\views/admin/partial/sidebar.blade.php ENDPATH**/ ?>