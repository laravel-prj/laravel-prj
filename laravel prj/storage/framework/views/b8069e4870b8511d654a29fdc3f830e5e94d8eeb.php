            ...
            <tbody>
                <?php $__currentLoopData = $data['listCart']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <?php if($item['image']): ?>
                            <td>
                                <img src="https://moshoptestest.000webhostapp.com/<?php echo e($item['image']); ?>" alt="img">
                            </td>
                        <?php else: ?>
                            <td>
...
<?php /**PATH C:\xampp8\htdocs\laravel-prj\laravel prj\resources\views/mails/mail-notify.blade.php ENDPATH**/ ?>