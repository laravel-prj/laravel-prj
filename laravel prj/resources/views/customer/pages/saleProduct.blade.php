                                    ...
                                    <li>
                                        <figure>
                                            <a class="aa-product-img" href="{{ asset("detail/$item->id") }}"><img
                                                    ...
                                                    alt="{{ $item->name }}" width="100%" height="300px"></a>
                            ...
                            <div class="aa-recently-views">
                                <ul>
                                    @foreach ($sale as $sales)
                                        <li>
                                            <a href="{{ asset("detail/$sales->id") }}" class="aa-cartbox-img"><img
                                                    alt="img" src="{{ asset("customer/img/$sales->image") }}"></a>
                                            <div class="aa-cartbox-info">
                                                <h4><a href="{{ asset("detail/$sales->id") }}">{{ $sales->name }}</a>
                                                </h4>
                                                <p>${{ $sales['price'] - ($sales['price'] * $sales['discout_item']) / 100 }}
                                                </p>
                                            </div>
                                        </li>
                                    @endforeach
