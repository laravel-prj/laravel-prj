              ...
              <ul class="seq-canvas">
                ...
                <li>
                  <div class="seq-model">
                    <img
                      data-seq
                      src="{{asset('customer/img/slide2.jpg')}}" style="height: 500px"
                    />
                  </div>
                  <div class="seq-title">
                    <a data-seq href="#" class="aa-shop-now-btn aa-secondary-btn"
                ...
                <li>
                  <div class="seq-model">
                    <img
                      data-seq
                      src="{{asset('customer/img/slide3.jpg')}}" style="height: 500px"
                    />
                  </div>
                  <div class="seq-title">
                    <a data-seq href="#" class="aa-shop-now-btn aa-secondary-btn"
                        ...
                        <li>
                            <figure>
                                ...
                                <a class="aa-product-img" href="{{asset("detail/$item->id")}}">
                                    ...
                                    @else
                                    <img
                                    src="{{asset("customer/img/no_image.png")}}"
                                    alt="polo shirt img"/>
                                    @endif

                                </a>
                                <a class="aa-add-card-btn" data-product-id="{{$item->id}}" href="{{asset("detail/$item->id")}}"><span class="fa fa-shopping-cart">
                                  </span>Details
                                </a>
                              <figcaption>
