  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <!-- Brand Logo -->
      <a href="{{ asset('/admin-mo') }}"class="brand-link">
          <img src="{{ asset('admin/images/logo.png') }}" alt="MOteam Logo" class="brand-image img-circle elevation-3"
              style="opacity: .8">
          ...
          <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
               ...
               with font-awesome or any other icon font library -->
                  ...
                  <li class="nav-item">
                      <a href="{{ asset('admin-mo/item/index') }}" class="nav-link">
                  ...
                  <li class="nav-item">
                      <a href="{{ asset('admin-mo/itemType/index') }}" class="nav-link">
                          <i class="nav-icon fas fa-columns"></i>
                          <p>
                              Manager ItemTypes
                          </p>
                  ...
                  <li class="nav-item">
                      <a href="{{ asset('admin-mo/brand/index') }}" class="nav-link">
